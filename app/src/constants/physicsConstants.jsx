...
export const ACC_WALK    = 80.59375;
export const ACC_RUN     = 90.390625;
export const DEC_REL     = 110.8125;
export const DEC_SKID    = 200.625;

export const MAX_WALK    = 130.75;
export const MAX_RUN     = 155.75;

// vertical / gravity
export const STOP_FALL   = 1575;
export const WALK_FALL   = 1800;
export const RUN_FALL    = 900;
